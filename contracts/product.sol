...
//     function viewProductItems () public view returns(uint256[] memory, bytes32[] memory, bytes32[] memory, bytes32[] memory, uint256[] memory, bytes32[] memory,uint256[] memory,bytes32[] memory) {
...
//         // emit CreateIdentifier(identifier);
//         return identifier;
//     }
