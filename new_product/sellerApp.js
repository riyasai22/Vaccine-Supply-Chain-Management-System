App = {
    ...
    registerProduct: function(event) {
        ...
        console.log(sellerName,sellerBrand,sellerCode,sellerPhoneNumber,sellerManager,sellerAddress,ManufacturerId)
        console.log(web3.fromAscii(sellerName),web3.fromAscii(sellerBrand),web3.fromAscii(sellerCode),sellerPhoneNumber,web3.fromAscii(sellerManager),web3.fromAscii(sellerAddress),web3.fromAscii(ManufacturerId))
        ...
        web3.eth.getAccounts(function(error,accounts){
            ...
            App.contracts.vaccine.deployed().then(function(instance){
                ...
                document.getElementById('sellerCode').innerHTML='';
                document.getElementById('sellerPhoneNumber').innerHTML='';
                document.getElementById('sellerManager').innerHTML='';
                document.getElementById('sellerAddress').innerHTML='';
                document.getElementById('manufacturerId').innerHTML='';
